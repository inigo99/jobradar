...
**The board** has eight tabs — Today, Active, Applied, Rejected, Discarded, Closed ads, Filtered out and Insights — with filters (text, work mode, where — your areas, your country or abroad —, job family, source, language, minimum salary and minimum match, remembered in your browser) and sorting by focus, match, date or salary. Each job shows both scores, its family, your strongest overlaps, your genuine gaps, the salary with its provenance, the latest reply from your inbox, and anything you should clarify before applying. *Filtered out* lists the ads just short on years in a table of their own; the ones far out of reach are only counted.
